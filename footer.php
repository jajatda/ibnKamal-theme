...
<footer x-data="{
     ...
     class="mt-10 bg-slate-100  dark:bg-green-950/10 dark:text-white border-t-2 rounded-none h-max border-slate-200/80 dark:border-neutral-700/50 shadow-[4px_0_6px_-1px_rgba(0,0,0,0.1)] backdrop-blur-2xl backdrop-saturate-200 ">
